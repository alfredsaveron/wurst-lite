...
public class SeedCracker implements ModInitializer
{
	...
	public static final ArrayList<SeedCrackerAPI> entrypoints =
		new ArrayList<>();
	...
	public void onInitialize()
	{
		...
		FabricLoader.getInstance()
			.getEntrypointContainers("seedcrackerx", SeedCrackerAPI.class)
			.forEach(entrypoint -> entrypoints.add(entrypoint.getEntrypoint()));
		
		FinderQueue.registerEvents();
		
		ClientCommandRegistrationCallback.EVENT.register((dispatcher,
			registryAccess) -> ClientCommands.registerCommands(dispatcher));
