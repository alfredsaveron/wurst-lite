...
public abstract class BlockFinder extends Finder
{
	...
	public BlockFinder(Level world, ChunkPos chunkPos, Block block)
	{
		...
		this.targetBlockStates
			.addAll(block.getStateDefinition().getPossibleStates());
	}
	
	public BlockFinder(Level world, ChunkPos chunkPos,
	...
	public List<BlockPos> findInChunk()
	{
		...
		ChunkAccess chunk =
			this.world.getChunk(this.chunkPos.getWorldPosition());
