...
{
	private final Queue<Tuple<Thread, ArrayList<BlockPos>>> blocksAndAction =
		new LinkedList<>();
	...
	public void tick()
	{
		...
		for(int i = 0; i < 5; i++)
		{
			...
			ServerboundPlayerActionPacket p = new ServerboundPlayerActionPacket(
				ServerboundPlayerActionPacket.Action.ABORT_DESTROY_BLOCK,
				currentBlocks.remove(0), Direction.DOWN);
