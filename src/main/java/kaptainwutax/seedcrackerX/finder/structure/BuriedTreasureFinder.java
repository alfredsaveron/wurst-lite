...
public class BuriedTreasureFinder extends BlockFinder
{
	...
	public List<BlockPos> findInChunk()
	{
		...
		if(!Features.BURIED_TREASURE.isValidBiome(BiomeFixer.swap(biome)))
		...
		result.removeIf(pos -> {
			...
			if(chest.hasProperty(ChestBlock.WATERLOGGED))
				return true;
		...
		result.forEach(pos -> {
			RegionStructure.Data<?> data =
				Features.BURIED_TREASURE.at(this.chunkPos.x, this.chunkPos.z);
