...
public class BiomeFixer
{
	...
	static
	{
		...
		COMPATREGISTRY.put("windswept_gravelly_hills",
	...
	public static Biome swap(net.minecraft.world.level.biome.Biome biome)
	{
		...
		net.minecraft.resources.ResourceLocation biomeID = clientPacketListener
			.registryAccess().registryOrThrow(Registries.BIOME).getKey(biome);
	...
	public static net.minecraft.world.level.biome.Biome swap(Biome biome)
	{
		...
		return biomeRegistries
			.get(ResourceKey.create(Registries.BIOME,
				net.minecraft.resources.ResourceLocation
					.withDefaultNamespace(biome.getName())))
			.orElse(biomeRegistries
