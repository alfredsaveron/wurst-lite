...
public class Log
{
	...
	public static void warn(String translateKey, Object... args)
	{
		...
		if(player != null)
		{
			schedule(() -> player.displayClientMessage(
	...
	public static void printSeed(String translateKey, long seedValue)
	{
		...
		Component text = ComponentUtils.wrapInSquareBrackets(
			(Component.literal(seed)).withStyle(style -> style
				.withColor(ChatFormatting.GREEN)
				.withClickEvent(
					new ClickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, seed))
	...
	{
		Component text =
			ComponentUtils.wrapInSquareBrackets((Component.literal(message))
				.withStyle(style -> style.withColor(ChatFormatting.GREEN)
					.withClickEvent(new ClickEvent(
						ClickEvent.Action.COPY_TO_CLIPBOARD, message))
					.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
						Component.translatable("chat.copy.click")))
