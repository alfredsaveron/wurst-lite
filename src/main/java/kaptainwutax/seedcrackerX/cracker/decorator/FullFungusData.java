...
public class FullFungusData
{
	...
	public FullFungusData(List<Integer> layerSizes, int[][][] layers,
		ArrayList<Integer> vines, boolean big, int height, int vineLayerSize,
		ArrayList<Integer> bigTrunkData, int estimatedData)
	{
	...
	private void generateBlock(int relativePos, int blockType,
		DynamicProgram device)
	{
