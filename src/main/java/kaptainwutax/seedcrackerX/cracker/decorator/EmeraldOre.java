...
public class EmeraldOre extends Decorator<Decorator.Config, EmeraldOre.Data>
{
	...
	{
		if(this.getVersion().isNewerThan(MCVersion.v1_17_1))
			return true;
		super.canStart(data, structureSeed, rand);
		
		int bound = this.getVersion() == MCVersion.v1_17 ? rand.nextInt(19) + 6
			: rand.nextInt(6) + 3;
	...
	@Override
	public boolean canStart(EmeraldOre.Data data, long structureSeed,
		WorldgenRandom rand)
	{
		return true;
		// super.canStart(data, structureSeed, rand);
	...
	{
		return biome == Biomes.GRAVELLY_MOUNTAINS
			|| biome == Biomes.MODIFIED_GRAVELLY_MOUNTAINS
			|| biome == Biomes.MOUNTAINS || biome == Biomes.WOODED_MOUNTAINS
	...
	public static class Data extends Decorator.Data<EmeraldOre>
	{
		...
		public Data(EmeraldOre feature, int blockX, int blockY, int blockZ,
			Biome biome)
		{
